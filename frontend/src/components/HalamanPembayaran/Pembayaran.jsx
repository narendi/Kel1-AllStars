    ...
    <div class="bg-gray-100 absolute  w-full h-full ">
      <div class="rounded-md  box-content h-96 w-96 p-4  absolute  left-96 top-0 object-none object-center bg-white">
        <div class="bg-blue-500 rounded-md absolute top-0 left-0 w-full h-16">
          <h1 class="absolute top-3 left-12 text-white font-semibold">
            NusaKMS
          </h1>
        </div>
        <div class="bg-white absolute top-10 border border-gray-900 rounded-md left-12 w-80 h-16 z-10 mx-auto ">
          <div class="bg-white absolute top-1 left-3 w-72 h-12">
            ...
            <p class="text-xs absolute right-0 top-0 ">
              Choose within 23:59:59
            </p>
          </div>
        </div>
        ...
        <div class="bg-gray-100 absolute top-32   left-0 w-full h-[65px] z-10 mx-auto">
          ...
          <p class="text-xs font-semibold absolute top-1 left-3">
            Credit/Debit Card
          </p>
        ...
        <div class="bg-gray-50 absolute top-48 left-0 w-full h-[65px] z-10 mx-auto">
          ...
          <div className="flex space-x-3 absolute top-3 left-3">
            ...
            <a href="https://www.example.com">
              <img
                src="https://blogger.googleusercontent.com/img/a/AVvXsEiJiuTTGeNBEmRhATgkdM9vQJ37F8AjqKCwn8Hw1_7hF97OwAptW3f95dRVfRydLHfjmP77O_9EpeNcovCXvwKnIGVrriTlZTW-SBLcqSx791gZSnBmfv7uP2jE7RzT-LzY75ZsQ-Fd6p_6pcqNgcjPxMGyYwK1zpRXLIiqI4-ZlcsIj_aZVRq8Hpwj=s16000"
                alt="Image Description"
                class="w-[40px] h-[35px]"
              />
            </a>
            <a href="https://www.example.com">
              <img
                src="https://freepngdesign.com/content/uploads/images/p-2813-2-bank-mandiri-logo-png-transparent-logo-699390155888.png"
                alt="Image Description"
                class="w-[55px] h-[55px]"
              />
            </a>
