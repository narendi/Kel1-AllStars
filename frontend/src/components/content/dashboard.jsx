    ...
    return(
        ...
        <div className="border border-black">
            ...
            <div className="grid grid-cols-3 ">
                <div className="border border-black text-center text-2xl my-3 mx-7 flex flex-col justify-center items-center" style={{ height: '120px' }}> 9 <div className="text-sm">Total Semua Pelatihan</div> </div>
                <div className="border border-black text-center text-2xl my-3 mx-7 flex flex-col justify-center items-center" style={{ height: '120px' }}> 1 <div className="text-sm">Pelatihan Sedang Berjalan</div> </div>
                <div className="border border-black text-center text-2xl my-3 mx-7 flex flex-col justify-center items-center" style={{ height: '120px' }}> 1 <div className="text-sm">Pelatihan Selesai</div> </div>
            </div>
        </div>
        <br />
