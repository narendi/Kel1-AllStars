    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-1">
        <img
          ...
          style={{ width: "550px" }}
          src="../../public/assets/konten/konten1.jpg"
          alt="gambar"
        />
        ...
        <div className="mt-2 ml-4 text-sm ">
          ...
          <div className="grid grid-cols-3">
            ...
            <div>
              <Link to="/pembayaran">
                <button className="w-full border border-black text-sm hover:text-white hover:bg-black hover:border-transparent py-1 px-4">
                  Bayar
                </button>
              </Link>
            </div>
