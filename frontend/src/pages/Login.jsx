    ...
    <div className="h-screen w-screen bg-gray-300">
        <div class="rounded-lg shadow-md box-content h-96 w-96 p-4  absolute  inset-0  left-96 top-16 object-none object-center bg-white ...">
            <div className="flex justify-between items-center">
             ...
             <a href="DaftarAkun" className="font-medium text-gray-900 dark:text-blue-500 hover:underline">
             <p className="text-block mt-1 leading-tight font-semibold text-sm text-gray-900">Daftar akun baru</p>
             </a>
            </div>
             <div>
